 ...
 * @date   January 2024
 *********************************************************************/
#ifndef HG_COLTC_COMPOSABLE_REPORTER
#define HG_COLTC_COMPOSABLE_REPORTER
...
namespace clt::lng
{
  ...
  {
    /// @brief Does nothing
    void message(u8StringView, const Option<SourceInfo>&, const Option<ReportNumber>&)
        const noexcept
    {
      // Does nothing
    }
    ...
    /// @brief Does nothing
    void warn(u8StringView, const Option<SourceInfo>&, const Option<ReportNumber>&)
        const noexcept
    {
      // Does nothing
    }
    ...
    /// @brief Does nothing
    void error(u8StringView, const Option<SourceInfo>&, const Option<ReportNumber>&)
        const noexcept
    {
      // Does nothing
    }
  ...
  struct ConsoleReporter
  {
    ...
    void message(
        u8StringView str, const Option<SourceInfo>& info,
...
#endif // !HG_COLTC_COMPOSABLE_REPORTER
