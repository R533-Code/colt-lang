...
QWORD OpCode_Negate(QWORD value, BuiltinTypeID type)
{
	...
	break; default: colt_unreachable("Invalid operand for OP_NEGATE!");
	}
	return result;
}
...
QWORD OpCode_Convert(QWORD value, BuiltinTypeID from, BuiltinTypeID to)
{
	...
	break; case ID_COLT_BOOL:
		...
		break; default:
			colt_unreachable("Invalid operand for OP_CONVERT!");
		}
	...
	break; default:
		colt_unreachable("Invalid operand to convert to for OP_CONVERT!");
	}
...
QWORD OpCode_Sum(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; default: colt_unreachable("Invalid operand for OP_ADD!");
	}
	return result;
}
...
QWORD OpCode_Difference(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.f = left.f - right.f;
	break; case COLTI_DOUBLE_ID:	result.d = left.d - right.d;
	break; default: colt_unreachable("Invalid operand for OP_SUBTRACT!");
	}
	return result;
}
...
QWORD OpCode_Multiply(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.f = left.f * right.f;
	break; case COLTI_DOUBLE_ID:	result.d = left.d * right.d;
	break; default: colt_unreachable("Invalid operand for OP_MULTIPLY!");
	}
	return result;
}
...
QWORD OpCode_Divide(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.f = left.f / right.f;
	break; case COLTI_DOUBLE_ID:	result.d = left.d / right.d;
	break; default: colt_unreachable("Invalid operand for OP_DIVIDE!");
	}
	return result;
}
...
QWORD OpCode_Modulo(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 % right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 % right.u64;
	break; default: colt_unreachable("Invalid operand for OP_MODULO!");
	}
	return result;
}
...
QWORD OpCode_BitAND(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 & right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 & right.u64;
	break; default: colt_unreachable("Invalid operand for OP_BIT_AND!");
	}
	return result;
}
...
QWORD OpCode_BitOR(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 | right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 | right.u64;
	break; default: colt_unreachable("Invalid operand for OP_BIT_OR!");
	}
	return result;
}
...
QWORD OpCode_BitXOR(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 ^ right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 ^ right.u64;
	break; default: colt_unreachable("Invalid operand for OP_BIT_XOR!");
	}
	return result;
}
...
QWORD OpCode_BitNOT(QWORD value, BuiltinTypeID type)
{
	...
	break; default: colt_unreachable("Invalid operand for OP_BIT_NOT!");
	}
	return result;
}
...
QWORD OpCode_BitShiftL(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 << right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 << right.u64;
	break; default: colt_unreachable("Invalid operand for OP_BIT_SHIFT_L!");
	}
	return result;
}
...
QWORD OpCode_BitShiftR(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_U32_ID:		result.u32 = left.u32 >> right.u32;
	break; case COLTI_U64_ID:		result.u64 = left.u64 >> right.u64;
	break; default: colt_unreachable("Invalid operand for OP_BIT_SHIFT_R!");
	}
	return result;
}
...
QWORD OpCode_BoolNot(QWORD value, BuiltinTypeID type)
{
	...
	break; default: colt_unreachable("Invalid operand for OP_CMP_GREATER!");
	}
	return result;
}
...
QWORD OpCode_Less(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.b = left.f < right.f;
	break; case COLTI_DOUBLE_ID:	result.b = left.d < right.d;
	break; default: colt_unreachable("Invalid operand for OP_CMP_LESS!");
	}
	return result;
}
...
QWORD OpCode_GreaterEq(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.b = left.f >= right.f;
	break; case COLTI_DOUBLE_ID:	result.b = left.d >= right.d;
	break; default: colt_unreachable("Invalid operand for OP_CMP_GREATER_EQ!");
	}
	return result;
}
...
QWORD OpCode_LessEq(QWORD left, QWORD right, BuiltinTypeID type)
{
	...
	break; case COLTI_FLOAT_ID:		result.b = left.f <= right.f;
	break; case COLTI_DOUBLE_ID:	result.b = left.d <= right.d;
	break; default: colt_unreachable("Invalid operand for OP_CMP_LESS_EQ!");
	}
	return result;
}
...
void OpCode_Print(QWORD value, BuiltinTypeID type)
{
	...
	break; case COLTI_I8_ID:		printf("%"PRIi8, value.i8);
	break; case COLTI_I16_ID:		printf("%"PRIi16, value.i16);
	break; case COLTI_I32_ID:		printf("%"PRIi32, value.i32);
	break; case COLTI_I64_ID:		printf("%"PRIi64, value.i64);
