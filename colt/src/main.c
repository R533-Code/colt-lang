...
void debug_ast(StringView view, const char* byte_out)
{
...
int main(int argc, const char** argv)
{
	...
	if (args.file_path_in == NULL)
	{
		while (!feof(stdin))
		{
			...
			debug_ast(StringToStringView(&line), args.byte_code_out);
			StringFree(&line);
		}
	}
	else
	{
		...
		debug_ast(StringToStringView(&file_content), args.byte_code_out);
