...
static const Type ColtBool		= { .name.start = ColtBool_str,		.name.end = ColtBool_str + 4,		.type_id = COLTI_BOOL,		.byte_size = sizeof(ColtiBool) };
/// @brief Type representing a built-in unsigned 8-bit integer
static const Type ColtUInt8		= { .name.start = ColtU8_str,		.name.end = ColtU8_str + 3,			.type_id = COLTI_UINT8,		.byte_size = sizeof(ColtiU8) };
/// @brief Type representing a built-in unsigned 16-bit integer
static const Type ColtUInt16	= { .name.start = ColtU16_str,		.name.end = ColtU16_str + 3,		.type_id = COLTI_UINT16,	.byte_size = sizeof(ColtiU16) };
/// @brief Type representing a built-in unsigned 32-bit integer
static const Type ColtUInt32	= { .name.start = ColtU32_str,		.name.end = ColtU32_str + 3,		.type_id = COLTI_UINT32,	.byte_size = sizeof(ColtiU32) };
/// @brief Type representing a built-in unsigned 64-bit integer
static const Type ColtUInt64	= { .name.start = ColtU64_str,		.name.end = ColtU64_str + 3,		.type_id = COLTI_UINT64,	.byte_size = sizeof(ColtiU64) };
/// @brief Type representing a built-in signed 8-bit integer
static const Type ColtInt8		= { .name.start = ColtI8_str,		.name.end = ColtI8_str + 2,			.type_id = COLTI_INT8,		.byte_size = sizeof(ColtiI8) };
/// @brief Type representing a built-in signed 16-bit integer
static const Type ColtInt16		= { .name.start = ColtI16_str,		.name.end = ColtI16_str + 3,		.type_id = COLTI_INT16,		.byte_size = sizeof(ColtiI16) };
/// @brief Type representing a built-in signed 32-bit integer
static const Type ColtInt32		= { .name.start = ColtI32_str,		.name.end = ColtI32_str + 3,		.type_id = COLTI_INT32,		.byte_size = sizeof(ColtiI32) };
/// @brief Type representing a built-in signed 64-bit integer
static const Type ColtInt64		= { .name.start = ColtI64_str,		.name.end = ColtI64_str + 3,		.type_id = COLTI_INT64,		.byte_size = sizeof(ColtiI64) };
/// @brief Type representing a built-in float
static const Type ColtFloat		= { .name.start = ColtFloat_str,	.name.end = ColtFloat_str + 5,		.type_id = COLTI_FLOAT,		.byte_size = sizeof(ColtiFloat) };
/// @brief Type representing a built-in double
static const Type ColtDouble	= { .name.start = ColtDouble_str,	.name.end = ColtDouble_str + 6,		.type_id = COLTI_DOUBLE,	.byte_size = sizeof(ColtiDouble) };
